        ...
        <div class="container" >
            ...
            <form  action="MainController" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">          
                        <input type="date" class="form-control"  placeholder="First name" name="birthday" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" value="<%= updateAccount.getBirthday()%>" required="">
                    </div>
                </div>
